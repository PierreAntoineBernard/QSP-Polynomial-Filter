# QSP-Polynomial-Filter
Small workspace to compute the angles to use in the QSP protocol to implement polynomial eigenvalues filters.

Build a target Laurent polynomial from Chebyshev/C-D kernels, find a partner polynomial satisfying the SU(2) constraint $P(z)P(1/z) + Q(z)Q(1/z) = 1$ and extract QSP angles.
